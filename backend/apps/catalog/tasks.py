    ...
    try:
        ...
        def build_product_row(p):
            ...
            return {
                ...
                "selling_status": p.selling_status or "",
                "launch_date": str(p.launch_date) if p.launch_date else "",
                "release_date": str(p.release_date) if p.release_date else "",
                "exported_date": timezone.now().isoformat(),
                ...
                "vendor_wholesale_price_amount": str(getattr(p, "vendor_wholesale_price_amount", "")) if getattr(p, "vendor_wholesale_price_amount", None) is not None else "",
                "vendor_wholesale_price_currency": getattr(p, "vendor_wholesale_price_currency", "") or "",
                ...
                "inventory_threshold": str(p.inventory_threshold) if p.inventory_threshold is not None else "",
